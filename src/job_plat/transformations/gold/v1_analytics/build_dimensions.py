...
def build_dim_jobs(job_silver_df: DataFrame) -> DataFrame:
    return job_silver_df.groupBy("job_id").agg(
...
def build_dim_skills(job_skills_silver_df: DataFrame) -> DataFrame:
    return (
        job_skills_silver_df.groupBy("skills")
